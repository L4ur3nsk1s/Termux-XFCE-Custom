...
try:
    ...
    run_command("wget -N https://github.com/L4ur3nsk1s/Termux-XFCE-Custom/raw/main/xfce.py")
    run_command("wget -N https://github.com/L4ur3nsk1s/Termux-XFCE-Custom/raw/main/proot.py")
    run_command("wget -N https://github.com/L4ur3nsk1s/Termux-XFCE-Custom/raw/main/utils.py")
