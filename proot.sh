...
pd login debian --shared-tmp -- env DISPLAY=:1.0 wget https://github.com/L4ur3nsk1s/Termux-XFCE-Custom/raw/main/mesa-vulkan-kgsl_24.1.0-devel-20240120_arm64.deb
